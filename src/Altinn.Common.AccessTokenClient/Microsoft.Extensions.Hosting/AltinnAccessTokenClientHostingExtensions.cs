...
/// </summary>
public static class AltinnAccessTokenClientHostingExtensions
{
    /// <summary>
    ...
    public static IHostApplicationBuilder AddAltinnTokenClient(
        ...
        string keyVaultConfigurationSection = "kvSetting")
    {
        ...
        builder.Services.AddAltinnTokenGenerator(config, builder.Environment);
        return builder;
    }
}
